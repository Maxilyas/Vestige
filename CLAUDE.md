...
8b4. ⬜ Direction artistique des entités (joueur silhouette + cœur lumineux Résonance, ennemis redesignés, coffres avec animation d'ouverture)
8b5. ⬜ Refonte UI inventaire (cadre stylisé, slots, panneau détail enrichi)
...
- **Dernière étape franchie :** étape 8b3 — environnement vivant. 3 nouveaux modules dans `src/render/` :
