// Salle : Cristaux Glacés — La Crypte Votive (coin SO compact)
// (Phase 9.x — Migration Cristaux)
//
// INTENTION : carrefour bas reliant O (sol) et S (descente). Miroir de la
// Descente du Sanctuaire (coffre votif côté droit).
...
export const cristaux_coin_SO = {
    id: 'cristaux_coin_SO',
    biome: 'cristaux_glaces',
    nom: 'La Crypte Votive (SO)',
