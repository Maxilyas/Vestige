// Salle : Cristaux Glacés — La Niche Votive (impasse E compact)
// (Phase 9.x — Migration Cristaux)
//
// INTENTION : deadend. Entrée par la porte E (sol droite), ascension de
// marches de marbre vers une niche votive (coffre) en haut à gauche.
...
export const cristaux_impasse_E = {
    id: 'cristaux_impasse_E',
    biome: 'cristaux_glaces',
    nom: 'La Niche Votive (E)',
