// Salle : Cristaux Glacés — La Corniche Suspendue (impasse N compact)
// (Phase 9.x — Migration Cristaux)
//
// INTENTION : deadend. Entrée par la porte N (haut), descente en puits de
// marbre jusqu'au coffre au sol. On ressort par où on est venu.
...
export const cristaux_impasse_N = {
    id: 'cristaux_impasse_N',
    biome: 'cristaux_glaces',
    nom: 'La Corniche Suspendue (N)',
