// Salle : Cristaux Glacés — La Cella Scellée (impasse S compact)
// (Phase 9.x — Migration Cristaux)
//
// INTENTION : deadend. Entrée par la porte S (palier bas), ascension d'une
// cascade de marbre jusqu'au coffre au sommet (récompense l'escalade).
...
export const cristaux_impasse_S = {
    id: 'cristaux_impasse_S',
    biome: 'cristaux_glaces',
    nom: 'La Cella Scellée (S)',
