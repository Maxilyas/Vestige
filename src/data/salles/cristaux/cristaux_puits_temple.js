// Salle : Cristaux Glacés — Le Puits du Temple (NS compact)
// (Phase 9.x — Migration Cristaux)
//
// INTENTION : transition verticale lisible. Porte N en haut, porte S sur
// palier surélevé. Zigzag de paliers de marbre utilisable dans les deux
// sens. Coffre sur un palier latéral (récompense remontée).
...
export const cristaux_puits_temple = {
    id: 'cristaux_puits_temple',
    biome: 'cristaux_glaces',
    nom: 'Le Puits du Temple',
