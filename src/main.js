...
import { PopupLoreScene } from './scenes/PopupLoreScene.js';
...
window.game = new Phaser.Game({
    ...gameConfig,
    scene: [MenuScene, GameScene, UIScene, InventaireScene, FondeurScene, IdentifieurScene, MarchandScene, MapScene, FinScene, PopupLoreScene]
});
